...
/* ── Ícones externos (Instagram, WhatsApp) ─────────────────────────── */
...
export default function Footer() {
  return (
    <footer className="bg-footer-dark py-12 lg:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">

        {/* Grid principal — 2 colunas mobile / 4 desktop */}
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-2.5" role="list">
              {SERVICOS.map((s) => (
                <li key={s} className="font-body text-sm text-white/60">
                  {s}
                </li>
              ))}
            </ul>
          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-3" role="list">
              <li>
                <a
                  href={`${CONTATO.whatsappLink}?text=${encodeURIComponent(
                    "Olá! Gostaria de falar com a HouseUp Construtora."
                  )}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 font-body text-sm text-white/60 transition-colors duration-200 hover:text-white"
              ...
              <li>
                <a
                  href="https://instagram.com/houseup.construtora"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 font-body text-sm text-white/60 transition-colors duration-200 hover:text-white"
                  aria-label="Instagram da HouseUp"
                >
                  <IconInstagram />
                  {CONTATO.instagram}
                </a>
        ...
        <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-body text-xs text-muted">
            © 2025 HouseUp Construtora. Todos os direitos reservados.
          </p>
